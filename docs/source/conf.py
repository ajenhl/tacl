# -*- coding: utf-8 -*-
#
# TACL documentation build configuration file, created by
...
extensions = ['sphinx.ext.viewcode', 'sphinxcontrib.programoutput']
...
project = 'TACL'
copyright = '2012–2023, Jamie Norrish'
