...
class ReportTestCase (TaclTestCase):
    ...
    def test_generate_statistics (self):
        ...
        input_counts = (
            ...
            ['a', 'base', '3', '7', '29', '31', 'A'],
            ['a', 'base', '4', '11', '28', '31', 'A'],
            ['a', 'variant', '2', '6', '23', '24', 'A'],
            ['a', 'variant', '3', '7', '22', '24', 'A'],
            ['a', 'variant', '4', '7', '21', '24', 'A'],
            ['b', 'base', '2', '29', '200', '201', 'B'],
            ['b', 'base', '3', '42', '199', '201', 'B'],
            ['b', 'base', '4', '121', '198', '201', 'B'],
            ['b', 'variant', '2', '29', '200', '201', 'B'],
            ['b', 'variant', '3', '42', '199', '201', 'B'],
            ['b', 'variant', '4', '121', '198', '201', 'B'],
            ['c', 'base', '2', '9', '42', '43', 'A'],
            ['c', 'base', '3', '11', '41', '43', 'A'],
            ['c', 'base', '4', '12', '40', '43', 'A']
            )
        ...
        expected_rows = [
            ...
            ('a', 'variant', '7', '24', str(7 / 24 * 100), 'A'),
            ('b', 'base', '6', '201', str(6 / 201 * 100), 'B'),
            ('b', 'variant', '3', '201', str(3 / 201 * 100), 'B'),
